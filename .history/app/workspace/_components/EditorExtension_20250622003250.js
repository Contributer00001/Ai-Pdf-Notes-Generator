...
function EditorExtension({ editor }) {
    ...
    - Do NOT include explanations about how or why the answer is structured.
- Do NOT include any commentary or meta-statements (like "this HTML provides..." or "the answer is...").;
