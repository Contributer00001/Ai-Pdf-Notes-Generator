...
function EditorExtension({ editor }) {
    ...
    const onAiClick = async () => {
        ...
        const PROMPT = `
For question: ${selectedText} and with the given content as the answer, 
please generate an appropriate response in HTML format.

The answer content is:
${AllUnformattedAns}

Guidelines:
- Only output HTML content (<p>, <ul>, <li>, <b>, etc.).
- Do NOT include explanations or comments like:
  "This HTML provides..." or "The answer is..."
- Do NOT repeat the question or mention formatting.
- Just return the answer as clean, semantic HTML.
`;
